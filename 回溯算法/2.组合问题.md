...
## [#](https://www.programmercarl.com/0077.%E7%BB%84%E5%90%88.html#%E7%AE%97%E6%B3%95%E5%85%AC%E5%BC%80%E8%AF%BE)算法公开课
...
## [#](https://www.programmercarl.com/0077.%E7%BB%84%E5%90%88.html#%E6%80%9D%E8%B7%AF)思路
...
### [#](https://www.programmercarl.com/0077.%E7%BB%84%E5%90%88.html#%E5%9B%9E%E6%BA%AF%E6%B3%95%E4%B8%89%E9%83%A8%E6%9B%B2)回溯法三部曲
...
- 时间复杂度: O (n * 2^n)
关于时间复杂度的解释：
时间复杂度分析： 在 `backtracking` 函数中，对于每一个数字 `i`，我们都有两个选择：要么选择 `i` 加入当前组合，要么不选择 `i`，继续尝试下一个数字。因此，对于每个数字，有两个分支。假设组合的长度是 `k`，数字范围是 `n`，那么递归调用的次数就是 `O(2^k)`。在每个递归调用中，`path.push_back(i)` 和 `path.pop_back()` 的操作都是常数时间的。
...
## [#](https://www.programmercarl.com/0077.%E7%BB%84%E5%90%88.html#%E6%80%BB%E7%BB%93)总结
...
## [#](https://www.programmercarl.com/0077.%E7%BB%84%E5%90%88.html#%E5%89%AA%E6%9E%9D%E4%BC%98%E5%8C%96)剪枝优化
...
```
## [#](https://www.programmercarl.com/0077.%E7%BB%84%E5%90%88.html#%E5%89%AA%E6%9E%9D%E6%80%BB%E7%BB%93)剪枝总结
